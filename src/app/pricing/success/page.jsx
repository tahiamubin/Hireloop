...
export default async function Success({ searchParams }) {
  ...
  if (status === "complete") {
    ...
    const res = await createSubscription(successInfo)
      ...
      <div className="w-full min-h-screen bg-zinc-950 text-zinc-50 flex flex-col justify-center items-center p-6 select-none">
        ...
        >
          ...
          <div className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-4 text-left space-y-3.5 text-xs mb-8">
            ...
            <div className="border-t border-zinc-800/60 pt-3 flex flex-col gap-1 text-zinc-500">
              ...
              <a
                ...
                className="text-[#5C53FE] hover:text-blue-300 font-medium inline-flex items-center transition"
              >
                orders@example.com
              </a>
            </div>
          ...
          <div className="space-y-3">
            <Link
              href="/dashboard"
              className="block w-full text-center text-xs font-semibold px-4 py-3
               bg-white hover:bg-[#5C53FE] text-black hover:text-whiten rounded-xl shadow-lg shadow-blue-950/30 transition duration-200"
            >
